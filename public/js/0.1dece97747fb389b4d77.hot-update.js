	...
	_createClass(Project, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'card-deck' },
				projects_json.map(function (dict) {
					return _react2.default.createElement(Card, { projectName: dict['name'], projectDesc: dict['desc'], projectTools: dict['tools'], github: dict['github'] });
				})
			);
		}
	}]);
