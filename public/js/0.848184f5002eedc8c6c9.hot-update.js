				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'info-container center-content-h' },
								_react2.default.createElement(
									'p',
									null,
									_react2.default.createElement(
								...
								_react2.default.createElement('i', { 'class': 'fa fa-envelope align-bottom', 'aria-hidden': 'true' }),
								_react2.default.createElement(
									'span',
									{ className: 'icon-caption' },
									'danielhui123@gmail.com'
								),
								_react2.default.createElement('i', { 'class': 'fa fa-phone align-bottom', 'aria-hidden': 'true' }),
								_react2.default.createElement(
									'span',
									{ className: 'icon-caption' },
									'267-234-8911'
					...
					_react2.default.createElement(
						'div',
						{ className: 'row' },
						_react2.default.createElement('div', { className: 'col-12' })
					)
				),
				_react2.default.createElement(
					'div',
