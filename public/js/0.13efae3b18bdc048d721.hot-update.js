		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'nav',
					{ className: 'navbar navbar-fixed-top navbar-light bg-faded', style: 'background-color: #64b26a;' },
					_react2.default.createElement(
						'div',
						{ className: 'container' },
						_react2.default.createElement('button', { 'class': 'navbar-toggler hidden-lg-up', type: 'button', 'data-toggle': 'collapse', 'data-target': '#navbarResponsive', 'aria-controls': 'navbarResponsive',
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'ul',
								{ clasclassNames: 'nav navbar-nav float-md-right' },
								_react2.default.createElement(
									'li',
