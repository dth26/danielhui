	...
	_createClass(Header, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement('div', { className: 'col-3 border' }),
				_react2.default.createElement(
					'div',
					{ className: 'col-2 border' },
					_react2.default.createElement('img', { className: 'img-cir  img-fluid', src: 'images/dan.gif', alt: 'picture of Daniel Hui' })
				)
			);
		}
	}]);
