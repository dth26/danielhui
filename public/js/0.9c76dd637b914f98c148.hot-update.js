		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-lg-10 col-md-10 col-sm-12 col-xs-12 border' },
						_react2.default.createElement(
							'h3',
							null,
							'DANIEL HUUUUI '
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'p',
							null,
							'Proin a erat nec augue pharetra fringilla. In hac habitasse platea dictumst. Vivamus augue nisi, accumsan non mollis a, interdum a velit. Nulla tincidunt nisl nisi, porta consectetur nisi sodales ut. Maecenas venenatis arcu eu tellus convallis eleifend. Donec eget odio vel elit pretium convallis. Nullam mi quam, congue ullamcorper imperdiet eget, posuere nec velit. Nunc sed fermentum purus. Etiam sed ante nunc.'
						)
					),
					_react2.default.createElement(
						'div',
						{ className: 'col-2 border float-right' },
						_react2.default.createElement('img', { className: 'img-cir float-right img-fluid rounded', src: 'images/dan.gif', alt: 'picture of Daniel Hui' })
					)
				)
			);
		}
