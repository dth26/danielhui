	...
	_createClass(Project, [{
		...
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'card-deck' },
				data.projects_json.map(function (dict) {
...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open '/Users/hui/Documents/apps/dan/public/data/projects-data.js'");
