...
$(window).scroll(function () {
	if ($('#header').hasClass('shrink')) {
		$('#navbar-fixed-top-override').fadeOut(600);
	}
});
...
$(window).scroll(function () {
	...
	timeout = setTimeout(function () {
		console.log('scrolling stopped');
		$('#navbar-fixed-top-override').fadeIn(600);
	}, delay);
});
...
// });
// $(window).scroll(function() {
// 	 $('#navbar-fixed-top-override').fadeIn(800);
//      console.log('done ');
// });
...
function getScrollDirectionIsDown() {
	var retVal = false;
